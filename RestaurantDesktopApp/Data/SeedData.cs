    ...
    public static class SeedData
    {
        ...
        public static List<MenuCategory> GetMenuCategories()
        {
            return new List<MenuCategory>
            {
                ...
                new MenuCategory { Id = 2, Name = "Plato Principal", Icon = "meal.png" },
                new MenuCategory { Id = 3, Name = "Bocadillos", Icon = "snacks.png" },
                new MenuCategory { Id = 4, Name = "Postres", Icon = "cake.png" },
        ...
        public static List<MenuItem> GetMenuItems()
        {
            return new List<MenuItem>
            {
                new MenuItem { Id = 1, Name = "Cerveza", Icon = "beer.png", Description = "Cerveza fría", Price = 4.99m },
                new MenuItem { Id = 2, Name = "Biryani", Icon = "biryani.png", Description = "Biryani de pollo picante", Price = 7.99m },
                new MenuItem { Id = 3, Name = "Panecillos", Icon = "buns.png", Description = "Panecillos recién horneados", Price = 2.99m },
                new MenuItem { Id = 4, Name = "Combo de Hamburguesa y Papas Fritas", Icon = "burger_fries_combo.png", Description = "Hamburguesa con papas fritas", Price = 5.99m },
                new MenuItem { Id = 5, Name = "Pastel", Icon = "cake.png", Description = "Delicioso pastel de chocolate", Price = 3.99m },
                ...
                new MenuItem { Id = 8, Name = "Café", Icon = "coffee.png", Description = "Café caliente", Price = 1.99m },
                ...
                new MenuItem { Id = 12, Name = "Comida Rápida", Icon = "fast_food.png", Description = "Comida rápida y sabrosa", Price = 5.99m },
                new MenuItem { Id = 13, Name = "Pescado con Papas Fritas", Icon = "fish_and_chips.png", Description = "Pescado crujiente con papas fritas", Price = 6.99m },
                new MenuItem { Id = 14, Name = "Pescado", Icon = "fish.png", Description = "Pescado a la parrilla", Price = 7.99m },
                new MenuItem { Id = 15, Name = "Papas Fritas", Icon = "french_fries.png", Description = "Papas fritas crujientes", Price = 2.99m },
                new MenuItem { Id = 16, Name = "Pollo Frito", Icon = "fried_chicken.png", Description = "Pollo frito crujiente", Price = 5.99m },
                new MenuItem { Id = 17, Name = "Huevo Frito", Icon = "fried_egg.png", Description = "Huevo frito a la plancha", Price = 1.49m },
                new MenuItem { Id = 18, Name = "Arroz Frito", Icon = "fried_rice.png", Description = "Arroz frito sabroso", Price = 4.99m },
                new MenuItem { Id = 19, Name = "Hamburguesa", Icon = "hamburger.png", Description = "Jugosa hamburguesa", Price = 4.99m },
                new MenuItem { Id = 20, Name = "Hotdog", Icon = "hotdog.png", Description = "Hotdog a la parrilla", Price = 3.49m },
                new MenuItem { Id = 21, Name = "Helado", Icon = "ice_cream.png", Description = "Helado frío", Price = 2.99m },
                new MenuItem { Id = 22, Name = "Plato de Idli", Icon = "idli_platter.png", Description = "Plato de idli al estilo sur de la India", Price = 3.99m },
                new MenuItem { Id = 23, Name = "Kebab", Icon = "kebab.png", Description = "Kebab a la parrilla", Price = 5.99m },
                new MenuItem { Id = 24, Name = "Kimchi Jjigae", Icon = "kimchi_jjiage.png", Description = "Estofado de kimchi picante", Price = 6.99m },
                new MenuItem { Id = 25, Name = "Laddu", Icon = "laddu.png", Description = "Dulce laddu", Price = 1.99m },
                new MenuItem { Id = 26, Name = "Langosta", Icon = "lobster.png", Description = "Langosta fresca", Price = 15.99m },
                new MenuItem { Id = 27, Name = "Mango", Icon = "mango.png", Description = "Mango maduro", Price = 1.49m },
                new MenuItem { Id = 28, Name = "Masala Dosa", Icon = "masala_dosa.png", Description = "Masala dosa crujiente", Price = 4.99m },
                new MenuItem { Id = 29, Name = "Comida", Icon = "meal.png", Description = "Comida completa", Price = 9.99m },
                new MenuItem { Id = 30, Name = "Nachos", Icon = "nachos.png", Description = "Nachos con queso", Price = 3.99m },
                new MenuItem { Id = 31, Name = "Fideos", Icon = "noodles.png", Description = "Fideos salteados", Price = 4.99m },
                new MenuItem { Id = 32, Name = "Jugo de Naranja", Icon = "orange_juice.png", Description = "Jugo de naranja fresco", Price = 2.49m },
                new MenuItem { Id = 33, Name = "Panqueques", Icon = "pancakes.png", Description = "Panqueques esponjosos", Price = 3.99m },
                ...
                new MenuItem { Id = 36, Name = "Tarta", Icon = "pie.png", Description = "Tarta de frutas", Price = 3.99m },
                new MenuItem { Id = 37, Name = "Rebanada de Pizza", Icon = "pizza_slice.png", Description = "Rebanada de pizza", Price = 2.99m },
                ...
                new MenuItem { Id = 40, Name = "Arroz", Icon = "rice.png", Description = "Arroz al vapor", Price = 1.99m },
                new MenuItem { Id = 41, Name = "Pollo Asado", Icon = "roasted_chicken.png", Description = "Pollo asado", Price = 7.99m },
                new MenuItem { Id = 42, Name = "Ensalada en Bol", Icon = "salad_bowl.png", Description = "Ensalada fresca en bol", Price = 4.99m },
                new MenuItem { Id = 43, Name = "Plato de Ensalada", Icon = "salad_plate.png", Description = "Plato de ensalada fresca", Price = 4.99m },
                ...
                new MenuItem { Id = 46, Name = "Bocadillos", Icon = "snacks.png", Description = "Bocadillos variados", Price = 2.99m },
                new MenuItem { Id = 47, Name = "Refresco", Icon = "soda.png", Description = "Refresco refrescante", Price = 1.49m },
                new MenuItem { Id = 48, Name = "Bebida Gaseosa", Icon = "soft_drink.png", Description = "Bebida gaseosa fría", Price = 1.99m },
